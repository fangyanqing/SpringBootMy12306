			...
			<td background=${pageContext.request.contextPath}/images/bg_login1.jpeg height=250 width=300 style="margin-top:-5px">
				<form id="condition" name="condition" method="post" action="${pageContext.request.contextPath}/admin/login">
					<table width="300" height="250" border="0" align="center" cellpadding="0" cellspacing="0">
						<tr><td align="center" colspan="2" ><h2>登录/
						<a style="color:red;" id="btn" href="${pageContext.request.contextPath}/admin/reg">注册</a></h2></td></tr>
						<tr>
							<td style="height: 28px" width=80>登录姓名：</td>
